...
:   We did not have a final exam.
    See [the progress page](../progress.html) for how its score was calculated instead.
...
Lecture 41 -- Chip creation and global supply chains -- Monday 4 May 2026
:   Board work
...
:   Board work
    ...
    :   - [Polls](2026-03-11-polls.txt)
        - [Questions asked in class](2026-03-11-qa.txt)
...
:   Board work
    ...
    Relevant readings
    :   - [Main page](..)
        - [Goals of this course](../text/goals.html)
        - [Digital computers](../text/computer.html)

    Announcements
    :   [First homework](https://forms.gle/CrKUXPbkiW5DCbZs7) released early; if you haven't already, you'll need to [enable UIUC Google account](https://answers.uillinois.edu/illinois/47599) to file this form.
